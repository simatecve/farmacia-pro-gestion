...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      create_user_profile_by_admin: {
        Args: { full_name: string; user_email: string; user_roles?: string[] }
        Returns: Json
      }
      ...
      receive_purchase_order_item: {
        Args: { p_purchase_order_item_id: string; p_received_quantity: number }
        Returns: undefined
      }
      update_user_roles: {
