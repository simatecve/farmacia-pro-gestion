...
-- Note: available_stock is calculated automatically as current_stock - reserved_stock
INSERT INTO public.inventory (product_id, location_id, current_stock, reserved_stock)
SELECT 
    p.id as product_id,
